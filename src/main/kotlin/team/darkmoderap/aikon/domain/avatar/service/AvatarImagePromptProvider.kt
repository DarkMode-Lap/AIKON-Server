...
class AvatarImagePromptProvider {
    ...
    private fun buildStudioPrompt(
        ...
        구도는 얼굴과 상반신이 안정적으로 보이는 정면 또는 약간 사선의 프로필 구도로 잡아줘.
        피부는 자연스러운 질감을 유지하면서 깔끔하게 보정하되 과한 미백이나 인위적인 보정은 피하고,
        옷차림은 단정하고 고급스러운 모던 포트레이트 의상으로 정리해줘.
        고급 패션 매거진이나 브랜드 화보 수준의 상업 사진 퀄리티로 표현해줘.
        인물의 얼굴형, 눈코입, 헤어스타일, 표정, 전체적인 생김새는 원본 사진과 최대한 동일하게 유지해줘.
        손가락, 귀, 눈동자, 치아, 안경 같은 디테일이 어색하게 변형되지 않도록 자연스럽게 마무리해줘.
        """.trimIndent()
